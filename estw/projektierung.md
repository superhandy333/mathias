...
- [Elemente](#elemente)
    ...
    - [ProgrammfÃ¤lle](#programmf%C3%A4lle)
...
|beschreibung|ErlÃ¤uternder Text als Beschreibung zum Projektes (max. 254 Zeichen)||
...
|beschreibung|ErlÃ¤uternder Text als Beschreibung zum Elementtyp (max. 254 Zeichen)||
...
|projekt_id|Identifikationsnummer des [Projektes](#projekte), dem das Element angehÃ¶rt|x|
|typ_id|Identifikationsnummer des Elementtyps. Wert aus dem Feld `id` der Tabelle [Elementtypen](#elementtypen).|x|
|hauptelement_id|Identifikationsnummer des ESTW-Elementes, wenn dieses Element Ã¼ber kein eigenes ESTW-Element verfÃ¼gt.||
...
|beschreibung|ErlÃ¤uternder Text als Beschreibung zum Element (max. 254 Zeichen)||
...
|-|-|:-:|:-:|:-:|:-:|:-:|
|PR|RangierstraÃŸe zulÃ¤ssig<br>Gleis darf Element einer Rangierstrasse sein.|x|||||
|PZ|ZugstraÃŸe zulÃ¤ssig<br>Gleis darf Element einer Zugstrasse sein.|x|||||
|PRS|RangierstraÃŸenstart zulÃ¤ssig<br>Signal darf Startelement einer Rangierstrasse sein.|||x|||
|PRZ|RangierstraÃŸenziel zulÃ¤ssig<br>Signal darf Zielelement einer Rangierstrasse sein.|||x|x||
|PZS|ZugstraÃŸenstart zulÃ¤ssig<br>Signal darf Startelement einer Zugstrasse sein.|||x|||
|PZZ|ZugstraÃŸenziel zulÃ¤ssig<br>Signal darf Zielelement einer Zugstrasse sein.|||x|x||
...
|PZSP|Zielsperre<br>Signal kann wÃ¤hrend es als Flankenschutzelement dient, nicht gleichzeitig Ziel einer Rangierstrasse dienen. Signal kann wÃ¤hrend es Ziel einer Rangierstrasse, nicht gleichzeitig als Flankenschutzelement dienen.|||x|||
...
|beschreibung|ErlÃ¤uternder Text als Beschreibung zum Fahrstrassenelementtyp (max. 254 Zeichen)||
