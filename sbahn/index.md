...
<style>
.progress-container {
  /* Die Berechnung der Breite erfolgt automatisch: (Aktuell / Gesamt) * 100% */
  --progress-width: calc(var(--current) / var(--total) * 100%);
...
.progress-fill {
  /* Nutzt die oben berechnete Variable */
  width: var(--progress-width);
  height: 100%;
  background: linear-gradient(90deg, #27ae60, var(--main-color));
  border-radius: 12px;
...
|Heerstraße|S3, S9|||
|Hegermühle|S5|||
|Heidelberger Platz<br>[![Heidelberger Platz](thumbs/heidelberger_platz.jpg)](images/heidelberger_platz.jpg)|S41, S42, S46|||
|Heiligensee|S25|||
|Henningsdorf|S25|||
